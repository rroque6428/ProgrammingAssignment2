...
makeCacheMatrix <- function(x = matrix()) {
    ...
    get <- function() x # just return the original matrix
    ...
    # I've included a 'makeCacheMatrix' property, so calling functions can
...
# 'makeCacheMatrix' function. If an inverse is cached it is returned.
